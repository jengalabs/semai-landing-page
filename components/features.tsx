export function Features() {
  const features = [
    ...
    },
    {
      ...
      description: "Get help any time of day or night. Our AI never sleeps and responds within seconds.",
    },
    {
      icon: WalletIcon,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            AI assistance designed for Kenya. Simple, accessible, and affordable.
          </p>
        </div>
